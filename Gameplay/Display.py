...
def draw_board(screen, board, shape=None, shape_name=None, position=(0, 0), x_offset=0, fake=False):
    ...
    :param fake: If true, draw shape in gray.
    """
...
def draw_game_over(screen, final_score, elapsed_time, x_offset=0):
    ...
    score_text = small_font.render(f"Final Score: {final_score}", True, Definitions.PURPLE)
    ...
    time_text = small_font.render(f"Time Played: {elapsed_time}s", True, Definitions.PURPLE)
